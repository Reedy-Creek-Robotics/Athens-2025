...
public class AutoRedClose extends OpMode {
    ...
    private final Pose spike1Pose = new Pose(124,84,Math.toRadians(45));
    private final Pose spike2PrePose = new Pose(90,60,Math.toRadians(0));
    private final Pose spike2Pose = new Pose(124,60,Math.toRadians(0));
